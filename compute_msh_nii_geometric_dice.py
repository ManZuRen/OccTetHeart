...
def parse_args():
    ...
    parser.add_argument("--target-rescale", type=float, default=0.01, help="Scale applied to NIfTI spacing, matching MRI-TET training.")
    parser.add_argument("--mesh-is-local", action="store_true", help="Mesh is already in MRI-TET centered local-grid coordinates.")
